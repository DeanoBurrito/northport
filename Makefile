...
run: $(ARCH_DEFAULT_TARGET) $(QEMU_FW_FILE)
	$(LOUD)$(QEMU_BASE) $(QEMU_ACCEL) $(QEMU_HEADED)

.PHONY: run-headless
run-headless: $(ARCH_DEFAULT_TARGET) $(QEMU_FW_FILE)
	$(LOUD)$(QEMU_BASE) $(QEMU_ACCEL) $(QEMU_HEADLESS)

.PHONY: run-noaccel
run-noaccel: $(ARCH_DEFAULT_TARGET) $(QEMU_FW_FILE) 
	$(LOUD)$(QEMU_BASE) $(QEMU_NO_ACCEL) $(QEMU_HEADED)

.PHONY: debug
debug: $(ARCH_DEFAULT_TARGET) $(QEMU_FW_FILE)
	$(LOUD)$(QEMU_BASE) $(QEMU_NO_ACCEL) $(QEMU_DEBUG) $(QEMU_HEADED)

.PHONY: debug-headless
debug-headless: $(ARCH_DEFAULT_TARGET) $(QEMU_FW_FILE)
	$(LOUD)$(QEMU_BASE) $(QEMU_NO_ACCEL) $(QEMU_DEBUG) $(QEMU_HEADLESS)
