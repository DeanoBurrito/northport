...
namespace sl
{
    ...
    template<typename T>
    constexpr inline void MapRange(sl::Span<T> data, T oldMin, T oldMax, 
        T newMin, T newMax)
    {
        if (oldMin == oldMax)
            return;
    ...
    {
        /* This function was taken from https://github.com/mintsuki/cc-runtime,
         * which is a rip of the LLVM compiler runtime library (different 
         * flavour of libgcc).
